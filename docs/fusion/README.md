...
1. `fusion-design.md` - product, architecture, data, security, billing, and compatibility decisions.
2. `fusion-implementation-plan.md` - staged execution plan with file ownership, tests, and validation commands.
